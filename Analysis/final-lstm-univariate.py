...
# dataframe for univariate 
df_input = df_input[['cross_cafe', 'Day sin', 'Day cos']]
...
multi_window.plot(last_baseline, title= 'Last observation (Sales) 168 hours')
...
multi_window.plot(repeat_baseline, title = 'Previous window (Sales) 168 hours')
...
multi_window.plot(multi_dense_model, title= 'Dense Neural Network (Sales) 168 hours')
plt.plot(history.history['loss'], label='train')
plt.plot(history.history['val_loss'], label='validation')
plt.title("Dense Loss 168 hours (Sales)")
plt.legend();
...
multi_window.plot(multi_conv_model, title = "Convolutional Neural Network (Sales) 168 hours")
plt.plot(history.history['loss'], label='train')
plt.plot(history.history['val_loss'], label='validation')
plt.title("Conv loss 168 hours (Sales)")
plt.legend();
...
multi_window.plot(multi_lstm_model, title = 'LSTM (Sales) 168 hours')
plt.plot(history.history['loss'], label='train')
plt.plot(history.history['val_loss'], label='validation')
plt.title("LSTM loss 168 hours (Sales)")
plt.legend();
